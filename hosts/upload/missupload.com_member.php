...
<?php
			...
			$post['x'] = "0" ;
			$post['y'] = "0" ;
			$page = geturl("missupload.com", 80, "/login.html", 0, 0, $post, 0, $_GET["proxy"], $pauth);
			is_page($page);
			...
			$page = geturl("missupload.com", 80, "/?op=my_files", "http://missupload.com/login.html", $cookies, 0, 0, "");
			is_page($page);
