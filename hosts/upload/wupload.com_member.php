...
####### Account Info. ###########
$wupload_login = "";                   //Set your wupload.com user
$wupload_pass = "";                    //Set your wupload.com password
##############################

/**
 * Wupload Logged-In User Upload
 *
 * This class is using the Wupload API to process uploads.
 *
 * @author MathieuB (Wupload Developer)
 * @version 1.0
 *
 */
