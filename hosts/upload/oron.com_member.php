...
<?php
			...
			$post['op'] = "login" ;
			$post['redirect'] = "" ;
			$page = geturl("oron.com", 80, "/login.html", 'http://oron.com/', 0, $post, 0, $_GET["proxy"], $pauth);
			is_page($page);
			...
			$page = geturl("oron.com", 80, "/?op=my_files", "http://oron.com/", $cookies, 0, 0, "");
			is_page($page);
...
// Made by Baking 10/07/2009 14:18
?>