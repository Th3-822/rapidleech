...
$continue_up=false;
if ($bu_login & $bu_pass){
	$_REQUEST['login'] = $bu_login;
	$_REQUEST['password'] = $bu_pass;
...
<tr><td align=center>
<div id=login width=100% align=center>Login to biggerupload.com</div>
<?php
			$post['op'] = "login" ;
			$post['redirect'] = "" ;
			...
			$post['x'] = "0" ;
			$post['y'] = "0" ;
			$page = geturl("www.biggerupload.com", 80, "/login.html", 0, 0, $post, 0, $_GET["proxy"], $pauth);
			is_page($page);
			...
			$page = geturl("www.biggerupload.com", 80, "/?op=my_files", "http://www.biggerupload.com/login.html", $cookies, 0, 0, "");
			is_page($page);
...
// Made by Baking 14/07/2009 01:12
?>