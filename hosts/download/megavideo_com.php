...
$src = $_GET ['link'];
$clean_up = str_replace ( 'http://www.megavideo.com/?v=', '', $src );
$dorm = "http://www.megavideo.com/xml/player_login.php?u={$mu_cookie_user_value}&v=" . $clean_up;
$Url = parse_url ( $dorm );
$page = geturl ( $Url ["host"], $Url ["port"] ? $Url ["port"] : 80, $Url ["path"] . ($Url ["query"] ? "?" . $Url ["query"] : ""), 0, 0, 0, 0, $_GET ["proxy"], $pauth );
if (preg_match ( '|downloadurl="(http.*)" />|U', $scrape, $result )) {
