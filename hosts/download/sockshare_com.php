...
class sockshare_com extends DownloadClass {
	public function Download($link) {
		...
		if ($getv) {
			...
			if (!preg_match('@"(http://[^\.|"]+\.sockshare.com/\w+/\w+/([^/|"]+)/[^"]+)"@i', $page, $downl)) html_error('Error: Stream link not found.');
...
//[18-8-2011]  Written by Th3-822 && 'putlocker' replaced for 'sockshare' for work with sockshare.com. - Th3-822
