...
<?php
			...
			$post['x'] = "0" ;
			$post['y'] = "0" ;
			$page = geturl("metahyper.com", 80, "/", 'http://metahyper.com/', 0, $post, 0, $_GET["proxy"], $pauth);
			is_page($page);
			...
			$page = geturl("metahyper.com", 80, "/?op=my_files", "http://metahyper.com/", $cookies, 0, 0, "");
			is_page($page);
