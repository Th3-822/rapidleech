...
if ($ezy_login & $ezy_pass){
	$_REQUEST['login'] = $enter_login;
	$_REQUEST['password'] = $enter_pass;
...
<tr><td align=center>
<div id=login width=100% align=center>Login to enterupload.com</div>
<?php
			$post['op'] = "login" ;
			$post['redirect'] = "" ;
			...
			$post['x'] = "0" ;
			$post['y'] = "0" ;
			$page = geturl("enterupload.com", 80, "/login.html", 0, 0, $post, 0, $_GET["proxy"], $pauth);
			is_page($page);
			...
			$page = geturl("enterupload.com", 80, "/?op=my_files", "http://enterupload.com/login.html", $cookies, 0, 0, "");
			is_page($page);
...
// Made by churongcon  on 12 Jan 2010
?>