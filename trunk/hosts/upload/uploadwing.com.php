...
<?php
	...
	$uurl= 'http://uploadwing.com/cgi-bin/upload.cgi?upload_id='.$uid.'&js_on=1';
	$url=parse_url('http://uploadwing.com/cgi-bin/upload.cgi?upload_id='.$uid.'&js_on=1');
?>
...
// Made by Baking 30/06/2009 21:28
?>