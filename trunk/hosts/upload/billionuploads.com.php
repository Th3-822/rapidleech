...
/* # Plugin's Settings # */
$_T8['domain'] = 'upload.billionuploads.com'; // May require the www. (Check first if the site adds the www.)
...
// Advanced Settings (Don't edit it unless you know what are you doing)
	...
	$_T8['flashUpload'] = true; // Forces the use of flash upload method... Also filename for .cgi if it's a non empty string. (XFS Pro)
...
if (!empty($download_link)) $download_link = str_ireplace('://upload.', '://', $download_link);

// Written by Th3-822 - Last Update: [21-9-2013]
// [11-11-2013] Edited for billionuploads's "API". - Th3-822
