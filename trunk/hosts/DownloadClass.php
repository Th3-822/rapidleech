...
class DownloadClass {
	...
	*/
	...
	public function JSCountdown($secs, $post = 0, $text='Waiting link timelock', $stop = 1) {
		...
		function fc2(){if(c>120){if(c2<=20){a2.innerHTML=a2.innerHTML+".";c2=c2+1}else{c2=10;a2.innerHTML=""}setTimeout("fc2()",100)}else{dl2.style.display="none"}}<?php echo "</script></form><br />";
