...
<?php global $premium_acc, $mu_cookie_user_value;
...
<table width="150" id="ytubeopt" style="display: none;">
<tr><td colspan="2" style="white-space: nowrap;"><input type="checkbox" name="ytdirect" /><small>&nbsp;<?php echo lang(217); ?></small></td></tr>
<tr>
...
<tr>
<td align="left"><label><input type="checkbox" name="imageshack_tor" id="imageshack_tor" onclick="javascript:var displ=this.checked?'':'none';document.getElementById('torpremiumblock').style.display=displ;" <?php if (is_array($imageshack_acc)) print ' checked="checked"'; ?> />&nbsp;<small><?php echo lang(229); ?></small></label><table width="150" id="torpremiumblock" style="display: none;">
...
<table width="150" id="mupremiumblock" style="display: none;">
...
<td><input id="splitchkbox" type="checkbox" name="split" onclick="javascript:var displ=this.checked?'':'none';document.getElementById('methodtd').style.display=displ;"<?php echo $_COOKIE["split"] ? ' checked="checked"' : ''; ?> />&nbsp;<?php echo lang(239); ?></td>
<td>&nbsp;</td>
<td id="methodtd"<?php echo $_COOKIE["split"] ? '' : ' style="display: none;"'; ?>>
<table>
<tr>
<td>
<?php echo lang(240); ?>:&nbsp;<select name="method"><option value="tc"<?php echo $_COOKIE["method"] == "tc" ? " selected" : ""; ?>><?php echo lang(241); ?></option><option value="rfc"<?php echo $_COOKIE["method"] == "rfc" ? ' selected="selected"' : ''; ?>><?php echo lang(242); ?></option></select>
</td>
</tr>
<tr>
<td>
<?php echo lang(243); ?>:&nbsp;<input type="text" name="partSize" size="2" value="<?php echo $_COOKIE["partSize"] ? $_COOKIE["partSize"] : 10; ?>" />&nbsp;<?php echo lang(244); ?></td>
</tr>
</table>
</td>
</tr>
...
print '<span class="autodel">'."Auto-Delete".': <b>'.$ddelay.'</b>&nbsp;'.lang(283).'</span>';
}else{
$ddelay = round($delete_delay/60);
print '<span class="autodel">'."Auto-Delete".': <b>'.$ddelay.'</b>&nbsp;'.lang(284).'</span>';
}
}
?>
</div>
