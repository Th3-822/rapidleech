...
$(function () {
	$('#navcell1').click(function() {
		$('#tb2, #tb3, #tb4').hide();
		$('#navcell2, #navcell3, #navcell4').removeClass('selected');
	...
	$('#navcell2').click(function() {
		$('#tb1, #tb3, #tb4').hide();
		$('#navcell1, #navcell3, #navcell4').removeClass('selected');
		$(this).addClass('selected');
		$('#tb2').fadeIn('slow');
	});
	...
	$('#navcell3').click(function() {
		$('#tb1, #tb2, #tb4').hide();
		$('#navcell1, #navcell2, #navcell4').removeClass('selected');
		$(this).addClass('selected');
		$('#tb3').fadeIn('slow');
	});
	...
	$('#navcell4').click(function() {
		$('#tb1, #tb2, #tb3').hide();
		$('#navcell1, #navcell2, #navcell3').removeClass('selected');
		$(this).addClass('selected');
		$('#tb4').fadeIn('slow');
	});
});
