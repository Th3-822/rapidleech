...
/* I'm sure there's got to be an easier way of doing this... oO */
$(function () {
	$('#navcell1').click(function() {
		$('#tb2').hide();
		$('#tb3').hide();
		$('#tb4').hide();
		$('#navcell2').css({'background-color' : 'transparent'});
		$('#navcell3').css({'background-color' : 'transparent'});
		$('#navcell4').css({'background-color' : 'transparent'});
	...
	$('#navcell2').click(function() {
		...
		$('#tb3').hide();
		$('#tb4').hide();
		$('#navcell1').css({'background-color' : 'transparent'});
		$('#navcell3').css({'background-color' : 'transparent'});
		$('#navcell4').css({'background-color' : 'transparent'});
		$(this).css({'background-color' : 'orange'});
		$('#tb2').fadeIn('slow');
