...
?>
<form method="post" name="flist"><input type="hidden" name="files[]" value='<?php echo $file["date"]; ?>' /> <br />
What do you want to do with this file?<br />
<div align="center">
<select name="act" onChange="javascript:void(document.flist.submit());" style="<?php if($disable_action) echo 'display:none'; ?>">
