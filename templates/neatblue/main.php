...
<tr>
	<td align="left">
		<input type="checkbox" name="user_pass" onclick="javascript:var displ=this.checked?'':'none';document.getElementById('usernpass').style.display=displ;" value="on" />&nbsp;<?php echo lang(210); ?>
	</td>
</tr>
...
<p style="text-align:center; font-size:10px">
	...
	<b>Mod by eqbal | Ajax'd by TheOnly92</b>
	</small>
</p>
...
<div id="sinfo">
	...
	<?php
	echo CREDITS;
	?><footer>&copy; Design : blacklizt</footer>
</div>
</td>
</tr>
</table>
